rule CVE_2014_0477
{
//This rule was generated by: ./yargen -m Email::Address -c CVE-2014-0477
	meta:
		component_name = "Email-Address module for Perl"
		component_version = "before 1.905"
		custom_title = "Email::Address before 1.905 denial of service"
		custom_level = "low"
		custom_description = "<p>The parse function in Email::Address module before 1.905 for Perl uses an inefficient regular expression, which allows remote attackers to cause a denial of service (CPU consumption) via an empty quoted string in an RFC 2822 address.</p>"
	strings:
