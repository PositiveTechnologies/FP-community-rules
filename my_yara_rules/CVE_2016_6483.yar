rule CVE_2016_6483
{
	...
	strings:
			$v5_2_0 = "if (!defined('SIMPLE_VERSION')) define('SIMPLE_VERSION', '520');" 
			$v5_2_1 = "if (!defined('SIMPLE_VERSION')) define('SIMPLE_VERSION', '521');" 
			$v5_2_2 = "if (!defined('SIMPLE_VERSION')) define('SIMPLE_VERSION', '522');" 
